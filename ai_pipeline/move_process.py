...
def get_command_and_movement(text):
    ...
    versus radians being chosen if we select a TURN command. You MUST include either radians or metres. The command value should be
